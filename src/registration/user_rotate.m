function aligned_scan = user_rotate(alignedToSphere, pcMri_model)
    ...
    % Define the color for the reference point cloud (red)
    refColor = [1 0 0];
    ...
    figure;
    pcshow(subsampledRefCloud.Location,'r', 'MarkerSize', 40);  % Display the reference model
