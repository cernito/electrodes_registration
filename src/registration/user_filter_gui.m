function filtered_scan_temp = user_filter_gui(prealigned_scan, parentTab)    
    ...
    function applyFilter()
        ...
        switch method
            case 1
                z_plane_value = input;
                filtered_scan_temp = filterAbovePlane(prealigned_scan, z_plane_value);
            case 2
                if numel(input) == 4
                    center = input(1:3);
                    radius = input(4);
                    filtered_scan_temp = filterOutsideSphere(prealigned_scan, center, radius);
                else
