function pcFinalElectrodePositions = refine_alignment_old(scan, pcElectrodes_aligned)
    ...
    % dont include M1 and M2
    m1_m2_idx = true(size(pcElectrodes_aligned.Location,1),1);
    m1_m2_idx([13, 19]) = false;
    electrodes_without_m_electrodes = pcElectrodes_aligned.Location(m1_m2_idx,:);
